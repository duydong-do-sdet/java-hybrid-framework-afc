...
public class Level_21_Data_Faker extends BaseTest {
    ...
    private DataFakerConfig dataFaker;
    ...
    public void beforeClass(String browserName, String appUrl) {
        ...
        dataFaker = getDataFakerFrom("US");

        firstName = dataFaker.fakeFirstName();
        lastName = dataFaker.fakeLastName();
        fullName = firstName + " " + lastName;
        emailAddress = dataFaker.fakeEmailAddress();
        password = dataFaker.fakePassword();
    }
